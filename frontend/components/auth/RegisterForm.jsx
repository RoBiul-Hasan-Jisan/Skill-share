...
const strengthColors = ['', 'bg-red-500', 'bg-yellow-500', 'bg-green-500', 'bg-emerald-600']
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        {password.length > 0 ? (
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="text-xs text-text-muted flex-shrink-0">{strengthLabels[strength]}</span>
          </div>
        ) : (
          <p className="text-xs text-text-muted mt-1.5">8+ characters, mixed case &amp; a number</p>
        )}
      </div>
      ...
      <div className="relative py-1">
        ...
        <div className="relative flex justify-center text-[11px] uppercase tracking-wider">
          <span className="bg-bg lg:bg-surface px-2 text-text-muted">or</span>
        </div>
      </div>
